...
def wound(ent, woundtype, quality) -> bool:
    '''
...
def __damagebp(bptarget, damage) -> int:
    ...
    if bptarget.hp <= 0:
        ...
        return 1
    return 0
def damagebp(ent, bptarget, dmg, dmgtype, quality):
    '''
        ...
        quality    int >=1: damage value -- how high of a priority of
    ...
    # handle organ and brain damage separately
...
##        if crippled==2: # dismembered
        pass # TODO: message like "yooo shit entity's BP fell off!!"
...
def attackbp(
    ...
    # organ and brain damage here
    #   (TODO)
    # how should this be done..?
    #   first check if bptarget type is one that has organs / brains in it
    #   then cause those wounds separately using wound(...)
    # wound(...) handles the message for the organ damage
    if dmgIndex >= 3:

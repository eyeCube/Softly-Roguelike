...
MAXGRIND_BONE       = 4
MAXGRIND_STONE      = 4
MAXGRIND_METAL_LOW  = 4
MAXGRIND_METAL      = 5
MAXGRIND_METAL_HIGH = 6
...
MAT_CARBON      : MAXGRIND_CARBON,
MAT_DIAMOND     : MAXGRIND_CARBON,
MAT_METAL       : MAXGRIND_METAL,
MAT_STEEL       : MAXGRIND_METAL_HIGH,
MAT_COPPER      : MAXGRIND_METAL_LOW,
MAT_ALUMINUM    : MAXGRIND_METAL_LOW,
